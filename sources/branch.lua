...
local Bucket = Names.Bucket
local FlowingWater = Names.FlowingWater
local FlowingLava = Names.FlowingLava
local Lava = Names.Lava
local LavaBucket = Names.LavaBucket
local Torch = Names.Torch
local Water = Names.Water
local WaterBucket = Names.WaterBucket
local CobbleStone = Names.CobbleStone
local Obsidian = Names.Obsidian
